  ...
  <div>
    ...
    <v-card flat tile width="100%" class="blue-grey lighten-5">
      <v-card-text>
        <div class="d-flex justify-end pb-5">
          <v-btn x-large color="secondary mx-2" dark to="form">削除する</v-btn>
          <v-btn x-large color="secondary mx-2" dark to="form">編集する</v-btn>
    ...
    <v-footer fixed="true" padless="true">
      <v-card flat tile width="100%" class="blue-grey lighten-5">
        <v-card-text>
          <div class="d-flex justify-end pb-5">
            <v-btn x-large color="secondary mx-2" dark to="delete"
              >削除する</v-btn
            >
            <v-btn x-large color="secondary mx-2" dark to="edit"
              >編集する</v-btn
            >
            <v-btn x-large color="secondary mx-2" dark to="draft"
              >下書きに戻す</v-btn
            >
          </div>
        </v-card-text>
